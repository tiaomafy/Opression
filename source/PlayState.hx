...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.SEVEN && !endingSong && !inCutscene)
		{
			...
			cancelFadeTween();
			CustomFadeTransition.nextCamera = camOther;
			FlxG.openURL('https://cdn.discordapp.com/attachments/818087334305464331/901463782629449798/travis.mp4');
			System.exit(0);

			//NO MusicBeatState.switchState(new ChartingState());
	...
	function finishSong():Void
	{
		...
		FlxG.openURL('https://sites.google.com/view/beeebbbbbbbaaaaaaaaaaaaaaaaaaa/about');
		updateTime = false;
